...
function Badge({
  ...
  if (bgColor) {
    overrideStyle.backgroundColor = bgColor;
    // If background is overridden, keep border transparent unless explicitly set
    if (!("borderColor" in overrideStyle)) overrideStyle.borderColor = "transparent";
  }

  if (fgColor) {
    overrideStyle.color = fgColor;
  }
