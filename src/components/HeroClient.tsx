...
export default function HeroClient() {
  ...
  // IMPORTANT: keep this wrapper position-relative and a higher z-index than the -z-10 background
  return (
    <div className="relative z-20 pointer-events-none">
      <div className="flex z-100 flex-row justify-around w-full backdrop-blur-sm rounded-xl bg-dark-translucent shadow-md shadow-dark-translucent-2 p-2">
        <AnimatedButton
